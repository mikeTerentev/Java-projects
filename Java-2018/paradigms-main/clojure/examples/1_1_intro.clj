...
(section "Variables")
(example "Define variable" '(def operate 10))
(example "Use variable" '(+ operate (* operate 3)))
(example "Output variable " '(println operate))

(section "First-order functions")
(example "Output function" '+)
(example "Assign function" '(def operate +))
(example "Variable as a function" '(operate 10))
